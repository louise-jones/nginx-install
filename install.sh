...
function CompileInstall(){
	...
	wget --no-check-certificate https://raw.githubusercontent.com/louise-jones/nginx-install/master/nginx.conf -P /usr/local/nginx/conf/
	#日志分割
	wget --no-check-certificate https://raw.githubusercontent.com/louise-jones/nginx-install/master/etc/logrotate.d/nginx -P /etc/logrotate.d/
